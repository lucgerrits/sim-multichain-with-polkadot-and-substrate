...
set output "stats_cloud_2_output_tps.eps"
...
plot 'renault_3_collator_stats_values.csv' using 3:7:xtic(1) title "Renault avg Output TPS" lc rgbcolor "blue" lt 1, \
    '' using 0:0:xtic(1):12 with labels font ",15" offset -1,0 tc rgb "red" rotate left notitle, \
    'insurance_3_collator_stats_values.csv' using 3:7:xtic(1) title "Insurance avg Output TPS" lc rgbcolor "pink" lt 1, \
    '' using 0:0:12:xtic(1) with labels font ",15" offset 1,0 tc rgb "red" rotate left notitle
...
plot 'renault_3_collator_stats_values.csv' using 5:9:xtic(1) title "Renault avg Blocktime" lc rgbcolor "blue" lt 1, \
    'insurance_3_collator_stats_values.csv' using 5:9:xtic(1) title "Insurance avg Blocktime" lc rgbcolor "pink" lt 1
