...
collator_format_4 = "4collator" 

######################################## output tps ##################################################
reset

set terminal postscript eps enhanced color font 'Times-Roman,20' size 7,5
...
set title "4 Collators - Input TPS vs Avg Output TPS"
...
plot './block_logs/'.choose_test_prefix.'renault_'.collator_format_4.'_stats_values.csv' using 3:7:xtic(1) title "OEM" lc rgbcolor "blue" lt 1, \
    '' using 0:0:xtic(1):12 with labels font ",15" offset -1,0 tc rgb "red" rotate left notitle, \
    './block_logs/'.choose_test_prefix.'insurance_'.collator_format_4.'_stats_values.csv' using 3:7:xtic(1) title "Insurance" lc rgbcolor "pink" lt 1, \
    '' using 0:0:12:xtic(1) with labels font ",15" offset 1,0 tc rgb "red" rotate left notitle
...
set title "4 Collators - Input TPS vs Test Time"
...
plot './block_logs/'.choose_test_prefix.'renault_'.collator_format_4.'_stats_values.csv' using 13:xtic(1) title "OEM" lc rgbcolor "blue" lt 1, \
    './block_logs/'.choose_test_prefix.'insurance_'.collator_format_4.'_stats_values.csv' using 13:xtic(1) title "Insurance" lc rgbcolor "pink" lt 1, \
    '' using 14:xtic(1) with lines title "Expected Test Time" lc rgbcolor "black" lt 2
