...
plot "block_logs/block_stats_Renault Chain.csv" using 1:3 with linespoints lw 2 title "Renault", \
    "block_logs/block_stats_Insurance Chain.csv" using 1:3 with linespoints lw 2 title "Insurance"
...
plot "block_logs/block_stats_Renault Chain.csv" using 1:4 with linespoints lw 2 title "Renault", \
    "block_logs/block_stats_Insurance Chain.csv" using 1:4 with linespoints lw 2 title "Insurance"
