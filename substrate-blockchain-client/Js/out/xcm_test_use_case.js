...
const myApp = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    txHash = yield parachainApiInstRenault.tx
    ...
    txHash = yield parachainApiInstInsurance.tx
        .palletSimInsuranceAccident.reportAccident(alice_account.publicKey, 1) //report first accident
        .signAndSend(alice_account);
    console.log("txHash: ", txHash.toHex());
    yield delay(50000);
    yield print_renault_status(parachainApiInstRenault);
    yield print_insurance_status(parachainApiInstInsurance);
    console.log("================Stop=================");
    process.exit(0);
});
myApp();
